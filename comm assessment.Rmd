...
example_NMDS=metaMDS(species_NMDS,k=2,trymax=10000) #k=2dimesnions amnd trymax=max number of random starts in                                                        search of stable solution (makes the iterations a bit                                                            longer)
example_NMDS
