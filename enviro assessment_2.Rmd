...
```{r}
df_list <- split(surf_enviro[,9:21], as.factor(surf_enviro$river)) #make sure rivers are alphabetically organized
df_list2 <- matrix(0,ncol=13,nrow=0)
...
plot(enviro_nipals,what="observations", col.points =st_data$river)
``` 
